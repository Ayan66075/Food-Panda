...
const loadDishes = async () => {
 ...
 if (auth.currentUser.email !== "ayan@gmail.com") {
                ...
                <div class="col-md-3 mb-3">
                    <div class="card admin">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn-admin btn-edit" data-id="${dishId}" data-bs-toggle="modal" data-bs-target="#editDishModal">Edit Dish</button>
                            <br><br>
                            <button class="btn-admin btn-delete" data-id="${dishId}">Delete</button>
                        </div>
                        </div>
                    </div>
                </div>
